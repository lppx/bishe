...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [_splashView setImage:[UIImage imageNamed:@"Bg-guide.png"]];
...
-(void)scale_1
{
    ...
    round_1.image = [UIImage imageNamed:@"round-100"];
...
-(void)scale_2
{
    ...
    round_2.image = [UIImage imageNamed:@"round-100"];
...
-(void)scale_3
{
    ...
    round_3.image = [UIImage imageNamed:@"round-100"];
...
-(void)scale_4
{
    ...
    round_4.image = [UIImage imageNamed:@"round-100"];
...
-(void)scale_5
{
    UIImageView *heart_1 = [[UIImageView alloc]initWithFrame:CGRectMake(110, 180, 100, 100)];
    heart_1.image = [UIImage imageNamed:@"sun-100"];
...
-(void)showWord
{
    ...
    word_.image = [UIImage imageNamed:@"wen"];
